...
apk update
apk add openssh ucspi-tcp6 iw wpa_supplicant dhcpcd dnsmasq hostapd iptables avahi dbus dcron chrony gpsd musl-dev libconfig-dev alsa-lib-dev alsa-utils curl wget less nano bc dos2unix
