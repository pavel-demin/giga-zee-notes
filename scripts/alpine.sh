...
zip -r giga-zee-alpine-3.6-armhf-`date +%Y%m%d`.zip apks apps boot.bin cache devicetree.dtb firmware giga-zee.apkovl.tar.gz uEnv.txt uImage uInitrd wifi

rm -rf apks apps cache firmware giga-zee.apkovl.tar.gz uInitrd wifi
